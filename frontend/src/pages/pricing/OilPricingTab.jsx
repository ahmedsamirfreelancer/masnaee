...
const DEFAULT_MONTHLY = {
  salaries: 103000,     // إجمالي المرتبات
  rent: 20000,          // إيجار
  fuel: 20000,          // بنزين/مواصلات
  utilities: 0,         // كهرباء ومياه
  depreciation: 19500,  // إهلاك أصول
  other: 0,             // مصاريف أخرى
};
...
export default function OilPricingTab() {
  ...
  return (
    <div className="space-y-6">
      {/* سعر الطن + ملخص */}
      <Card title="تسعير الزيت" action={<Button variant="ghost" size="sm" icon={Cog6ToothIcon} onClick={() => setSettingsModal(true)}>الإعدادات</Button>}>
